...
function chado_search_germplasm_search_by_image_table_definition () {
  $headers = array(      
    'uniquename:s:chado_search_germplasm_search_by_image_link_stock:stock_id' => 'Germplasm',
    'organism:s:chado_search_germplasm_search_by_image_link_organism:organism_id' => 'Species',
    'legend:s' => 'Legend',
    'image' => 'Image'
  );
  return $headers;
