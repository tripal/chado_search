...
function chado_search_qtl_nearby_markers_form ($form) {
  $form->addTabs(
      ...
      ->items(array('/find/markers' => 'Advanced Marker Search', '/find/nearby_markers' => 'Nearby Markers', '/find/qtl_nearby_markers' => 'QTL Nearby Markers'))
  );
...
function chado_search_qtl_nearby_markers_link_feature ($feature_id) {
  ...
  if (!$nid) {
    $nid = chado_get_nid_from_id('feature', $feature_id); // This is a QTL, not marker_locus
  }
